...
// Import any components your friends created for Orders and Inventory
...
const AdminDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      // Use your friends' components for orders and inventory
      // case "orders":
            ...
            <div className="ad-card">
              ...
              <div className="ad-grid">
                ...
                <div className="ad-grid-item">
                  ...
                  <p className="ad-grid-item-text">Monitor shipments and deliveries.</p>
                  <button 
            ...
            <div className="ad-sidebar">
              ...
              <nav>
                <ul className="ad-nav-list">
                  ...
                  {/* Keep the existing Order and Inventory buttons that your friends implemented */}
                  <li>
                    <button
